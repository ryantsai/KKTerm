...
const SECTION_SOURCES: Record<SettingsSectionId, readonly string[]> = {
  ...
  "custom-modules-settings": ["CustomModulesSettings.tsx"],
...
const SECTION_LABEL_KEYS: Record<SettingsSectionId, string> = {
  ...
  "custom-modules-settings": "settings.sectionCustomModules",
...
const NON_SEARCHABLE_KEYS: Record<SettingsSectionId, readonly string[]> = {
  ...
  "itops-settings": ["settings.itOpsSaved"],
  ...
  "custom-modules-settings": [
    "settings.customModulesPackageFilter", "settings.customModulesNoneInstalled",
    "settings.customModulesRefreshCatalog", "settings.customModulesCatalogRefreshedNotice",
    "settings.customModulesNoneAvailable", "settings.customModulesPublisher",
    "settings.customModulesVersion", "settings.customModulesTrustFirstParty",
    "settings.customModulesTrustLocal", "settings.customModulesNoPermissions",
    "settings.customModulesNotices", "settings.customModulesInstallTitle",
    "settings.customModulesInstallMessage", "settings.customModulesInstall",
    "settings.customModulesInstallVerifiedMessage", "settings.customModulesUpdateTitle",
    "settings.customModulesUpdateMessage", "settings.customModulesUpdate",
    "settings.customModulesInstalledNotice", "settings.customModulesUninstallTitle",
    "settings.customModulesUpdatedNotice",
    "settings.customModulesUninstallMessage", "settings.customModulesDeleteData",
    "settings.customModulesUninstalledNotice", "settings.customModulesHealthMissing",
    "settings.customModulesOpenLicense", "settings.customModulesOpenNotices",
    "settings.customModulesRollback", "settings.customModulesRolledBackNotice",
