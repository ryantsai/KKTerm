...
const macosTemplateNativeIconsBySvg = new Map<string, MenuIcon>([
  ...
  [nativeMenuIcons.bold, "FontPanel"],
  ...
  [nativeMenuIcons.fontFamily, "FontPanel"],
  [nativeMenuIcons.fontSize, "FontPanel"],
  [nativeMenuIcons.gitCompare, "Network"],
  [nativeMenuIcons.image, "Slideshow"],
  [nativeMenuIcons.info, "QuickLook"],
  [nativeMenuIcons.italic, "FontPanel"],
  [nativeMenuIcons.keyRound, "LockUnlocked"],
  [nativeMenuIcons.keyboard, "Computer"],
  [nativeMenuIcons.layoutDashboard, "IconView"],
  [nativeMenuIcons.lock, "LockLocked"],
  [nativeMenuIcons.maximize, "EnterFullScreen"],
  [nativeMenuIcons.moveDiagonal, "EnterFullScreen"],
  [nativeMenuIcons.moveHorizontal, "GoRight"],
  [nativeMenuIcons.moveVertical, "FlowView"],
  ...
  [nativeMenuIcons.rowInsert, "ListView"],
  [nativeMenuIcons.save, "Path"],
  [nativeMenuIcons.saveAs, "Path"],
  [nativeMenuIcons.scan, "QuickLook"],
  ...
  [nativeMenuIcons.square, "IconView"],
