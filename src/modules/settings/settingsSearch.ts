...
export const SETTINGS_SEARCH_KEYS: Record<SettingsSectionId, readonly string[]> = {
  "general-settings": [
    ...
    "settings.lastBackup", "settings.lastCheckedAt",
  ...
  "custom-modules-settings": [
    ...
    "settings.customModulesPermissions", "settings.customModulesModuleSize",
  ...
  "assistant-settings": [
    ...
    "settings.aiTools.currentTime.label", "settings.aiTools.currentTime.description",
    "settings.aiTools.webSearch.label", "settings.aiTools.webSearch.description",
    "settings.aiTools.webFetch.label", "settings.aiTools.webFetch.description",
    "settings.aiTools.appDataFileSearch.label", "settings.aiTools.appDataFileSearch.description",
    "settings.aiTools.appDataFileRead.label", "settings.aiTools.appDataFileRead.description",
    "settings.aiTools.performanceCounters.label", "settings.aiTools.performanceCounters.description",
    "settings.aiTools.email.label", "settings.aiTools.email.description",
    "settings.aiTools.shellCommand.label", "settings.aiTools.shellCommand.description",
    "settings.aiTools.dashboard.label", "settings.aiTools.dashboard.description",
    "settings.aiTools.itops.label", "settings.aiTools.itops.description",
    "settings.aiTools.installer.label", "settings.aiTools.installer.description",
    "settings.aiTools.systemCleaner.label", "settings.aiTools.systemCleaner.description",
    "settings.aiTools.screenshots.label", "settings.aiTools.screenshots.description",
    "settings.aiTools.connections.label", "settings.aiTools.connections.description",
    "settings.aiTools.sessions.label", "settings.aiTools.sessions.description",
    "settings.aiTools.tutorial.label", "settings.aiTools.tutorial.description",
    "settings.aiTools.manual.label", "settings.aiTools.manual.description",
    "settings.aiTools.network.label", "settings.aiTools.network.description",
    "settings.aiTools.watchdog.label", "settings.aiTools.watchdog.description",
    "settings.aiTools.memory.label", "settings.aiTools.memory.description",
    ...
    "settings.builtInMcpConfigTitle", "settings.exaSearchApiKey", "settings.braveSearchApiKey",
    ...
    "settings.extraHeaders", "settings.hideSensitiveHeaderValues",
    "settings.high", "settings.howToGetApiKey",
    ...
    "settings.searchProviderExa", "settings.searchProviderScraper",
  ...
  "terminal-settings": [
    ...
    "settings.copyOnSelect", "settings.rightClickPaste", "settings.rightClickPasteHint",
    "settings.offerSavedPasswords", "settings.offerSavedPasswordsHint", "settings.allowLocalOsc52Clipboard",
    ...
    "settings.syntaxHighlighting", "settings.syntaxHighlightingHint",
    "settings.syntaxHighlightBuiltIn", "settings.syntaxHighlightCustom",
    "settings.syntaxHighlightRulesCount", "settings.syntaxHighlightNewProfile",
    "settings.syntaxHighlightImport", "settings.syntaxHighlightImportTitle",
    "settings.syntaxHighlightIniFiles", "settings.syntaxHighlightImportFailed",
    "settings.syntaxHighlightGenerateWithAi", "settings.syntaxHighlightGenerate",
    "settings.syntaxHighlightGenerating", "settings.syntaxHighlightAiPrompt",
    "settings.syntaxHighlightAiPlaceholder", "settings.syntaxHighlightAiFailed",
    "settings.syntaxHighlightCopy", "settings.syntaxHighlightEdit",
    ...
    "settings.syntaxHighlightForeground", "settings.syntaxHighlightBackground",
    "settings.syntaxHighlightEnabled", "settings.syntaxHighlightInvalidPattern",
  ...
  "url-settings": [
    ...
    "settings.urlDownloadFolderHint", "settings.urlDownloadFolderBrowse",
    "settings.urlDownloadFolderSystemDefault", "settings.urlUserAgent",
  ...
  "screenshots-settings": [
    ...
    "settings.screenshotsBorderStyleSolid", "settings.screenshotsBorderStyleDashed",
    "settings.screenshotsBorderStyleDotted", "settings.performance",
