...
const DYNAMIC_BACKGROUND_COMPONENTS = {
  ...
  predictiveArc: PredictiveArcBg,
  liquidForm: LiquidFormBg,
  energyOrb: EnergyOrbBg,
  noiseFlow: NoiseFlowBg,
  streamConvergence: StreamConvergenceBg,
  bellField: BellFieldBg,
  flowField: FlowFieldBg,
  condensation: CondensationBg,
  generativeTree: GenerativeTreeBg,
  ribbonField: RibbonFieldBg,
  particleOrb: ParticleOrbBg,
  cloudField: CloudFieldBg,
  voidField: VoidFieldBg,
  recursiveErosion: RecursiveErosionBg,
  quanteraTradingBackground: QuanteraTradingBg,
  halftoneFlow: HalftoneFlowBg,
  constellationField: ConstellationFieldBg,
  particleDrift: ParticleDriftBg,
  particleNetwork: ParticleNetworkBg,
  amberHalftone: AmberHalftoneBg,
  matrixField: MatrixFieldBg,
  gatewayFlow: GatewayFlowBg,
  connectivityGraph: ConnectivityGraphBg,
  interfaceLines: InterfaceLinesBg,
  defenseLines: DefenseLinesBg,
  topoField: TopoFieldBg,
  sylvaLivingWorld: SylvaLivingWorldBg,
  templeNight: TempleNightBg,
