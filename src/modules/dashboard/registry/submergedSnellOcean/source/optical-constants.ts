...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (shared optical constants); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
