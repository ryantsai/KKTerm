...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (sky dome mesh + PMREM environment bake); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
