...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (vessel wake foam compute field); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
