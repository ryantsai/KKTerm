...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (baked 3D LUT color grade); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
import {
  ClampToEdgeWrapping,
  Data3DTexture,
  LinearFilter,
