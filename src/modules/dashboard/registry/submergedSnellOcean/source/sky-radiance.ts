...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (shared TSL sky radiance function); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
