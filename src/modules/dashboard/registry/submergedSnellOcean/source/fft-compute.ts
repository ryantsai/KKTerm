...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (packed WebGPU-compute inverse FFT); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
