...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (shared TSL hash/value-noise/fbm); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
