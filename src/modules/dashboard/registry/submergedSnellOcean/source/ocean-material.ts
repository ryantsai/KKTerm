...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (TSL ocean surface optics material); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
