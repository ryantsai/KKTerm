...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (underwater HDR medium/god-ray render pipeline); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
import {
  AdditiveBlending,
  AgXToneMapping,
  InstancedMesh,
