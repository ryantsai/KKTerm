...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (far ocean skirt ring geometry); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
