...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (JONSWAP/TMA directional spectrum generation); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
