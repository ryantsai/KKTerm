...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (differential-area caustics TSL pass); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
import {
  AdditiveBlending,
  Color,
  HalfFloatType,
