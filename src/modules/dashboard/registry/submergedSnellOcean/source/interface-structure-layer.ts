...
// @ts-nocheck -- vendored verbatim from the submerged-snell-ocean reference skill (Snell-window structure forward-projection layer); preserved byte-for-byte, matching fujiBackground.tsx's convention for other preserved-algorithm files.
import {
  BufferGeometry,
  Box3,
  Color,
