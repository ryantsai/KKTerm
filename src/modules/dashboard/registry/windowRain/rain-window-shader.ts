// GLSL source mirrored from ./rain-window.frag, kept as a plain string export
// (instead of a Vite `?raw` asset import) so it also loads cleanly under the
// project's Node-based test runner, which has no loader for `.frag` files.
export const rainWindowFragmentShader = `
#ifdef GL_ES
