// IT Ops Module shell. The visible module is Site-first; Batch Run plumbing
// stays mounted here so backend events and programmatic run requests keep
// working across the separate Site-owned pages.
...
export function ItOpsModule({
  ...
  useEffect(() => {
    ...
    void loadRunHistory();
    void loadTasks();
  }, [loadSites, loadRunHistory, loadTasks]);
