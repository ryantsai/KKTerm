...
export const AI_PROVIDER_MODEL_CATALOG: AiProviderModelCatalog = {
  ...
  anthropic: {
    ...
    models: [
      { id: "claude-fable-5-1", label: "Claude Fable 5.1", recommended: true, supportsImageInput: true },
  ...
  openrouter: {
    ...
    models: [
      ...
      { id: "google/gemini-3.8-flash", label: "Gemini 3.8 Flash", recommended: true, supportsImageInput: true },
      { id: "google/gemini-3.5-flash-lite", label: "Gemini 3.5 Flash-Lite", recommended: true, supportsImageInput: true },
      ...
      { id: "xiaomi/mimo-v2.5-pro", label: "MiMo-V2.5 Pro", recommended: true, supportsImageInput: false },
      ...
      { id: "minimax/minimax-m3", label: "MiniMax M3", recommended: true, supportsImageInput: true },
    ],
  },
  zai: {
  ...
  gemini: {
    ...
    models: [
      ...
      { id: "gemini-3.5-flash-lite", label: "Gemini 3.5 Flash-Lite", recommended: true, supportsImageInput: true },
  ...
  litellm: {
    ...
    models: [
      ...
      { id: "anthropic/claude-fable-5-1", label: "Claude Fable 5.1", recommended: true, supportsImageInput: true },
      { id: "anthropic/claude-fable-5", label: "Claude Fable 5", recommended: true, supportsImageInput: true },
      { id: "gemini/gemini-3.8-flash", label: "Gemini 3.8 Flash", recommended: true, supportsImageInput: true },
  ...
  ollama: {
    ...
    models: [
      ...
      { id: "qwen3.8", label: "Qwen3.8", recommended: true, supportsImageInput: true },
      { id: "nemotron-3.5-lightning", label: "Nemotron 3.5 Lightning", recommended: true, supportsImageInput: false },
  ...
  "ollama-cloud": {
    ...
    models: [
      ...
      { id: "kimi-k3", label: "Kimi K3", recommended: true, supportsImageInput: true },
      { id: "kimi-k2.7-code", label: "Kimi K2.7 Code", recommended: true, supportsImageInput: true },
      { id: "minimax-m3", label: "MiniMax M3", recommended: true, supportsImageInput: true },
      { id: "deepseek-v4-flash:0731", label: "DeepSeek V4 Flash 0731", recommended: true, supportsImageInput: false },
      { id: "deepseek-v4-pro:0813", label: "DeepSeek V4 Pro 0813", recommended: true, supportsImageInput: false },
      { id: "glm-5.2", label: "GLM-5.2", recommended: true, supportsImageInput: false },
  ...
  nvidia: {
    ...
    defaultReasoningEffort: "medium",
    models: [
      { id: "nvidia/nemotron-3.5-lightning-30b-a3b", label: "Nemotron 3.5 Lightning 30B A3B", recommended: true, supportsImageInput: false },
      { id: "deepseek-ai/deepseek-v4-flash-0731", label: "DeepSeek V4 Flash 0731", recommended: true, supportsImageInput: false },
      { id: "deepseek-ai/deepseek-v4-pro-0813", label: "DeepSeek V4 Pro 0813", recommended: true, supportsImageInput: false },
      ...
      { id: "nvidia/nemotron-nano-3-30b-a3b", label: "Nemotron 3 Nano 30B A3B", recommended: true, supportsImageInput: false },
      { id: "nvidia/llama-3.1-nemotron-nano-vl-8b-v1", label: "Nemotron Nano VL 8B", supportsImageInput: true },
  ...
  "openai-compatible": {
    ...
    models: [
      ...
      { id: "gemini-3.8-flash", label: "Gemini 3.8 Flash compatible", recommended: true, supportsImageInput: true },
