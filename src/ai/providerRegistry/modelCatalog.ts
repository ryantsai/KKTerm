...
export const AI_PROVIDER_MODEL_CATALOG: AiProviderModelCatalog = {
  ...
  openrouter: {
    ...
    models: [
      ...
      { id: "google/gemini-3.7-flash", label: "Gemini 3.7 Flash", recommended: true, supportsImageInput: true },
      { id: "x-ai/grok-4.6", label: "Grok 4.6", recommended: true, supportsImageInput: true },
  ...
  gemini: {
    ...
    defaultReasoningEffort: "medium",
    models: [
      { id: "gemini-3.7-flash", label: "Gemini 3.7 Flash", recommended: true, supportsImageInput: true },
      ...
      { id: "gemini-3.6-flash", label: "Gemini 3.6 Flash", supportsImageInput: true },
      { id: "gemini-3.5-flash", label: "Gemini 3.5 Flash", supportsImageInput: true },
  ...
  grok: {
    ...
    defaultReasoningEffort: "medium",
    models: [
      { id: "grok-4.6", label: "Grok 4.6", recommended: true, supportsImageInput: true },
      { id: "grok-4.3", label: "Grok 4.3", recommended: true, supportsImageInput: true },
      { id: "grok-4.5", label: "Grok 4.5", supportsImageInput: true },
    ],
  },
  "azure-openai": {
    defaultModel: "gpt-5.6-luna",
    ...
    models: [
      ...
      { id: "gpt-5.5-pro", label: "GPT-5.5 Pro", supportsImageInput: true },
      { id: "gpt-5.4-mini", label: "GPT-5.4 Mini", supportsImageInput: true },
      { id: "gpt-5.4", label: "GPT-5.4", supportsImageInput: true },
      { id: "gpt-5.4-pro", label: "GPT-5.4 Pro", supportsImageInput: true },
      { id: "gpt-5.4-nano", label: "GPT-5.4 Nano", supportsImageInput: true },
  ...
  litellm: {
    ...
    models: [
      { id: "openai/gpt-5.6-luna", label: "OpenAI GPT-5.6 Luna", recommended: true, supportsImageInput: true },
      { id: "anthropic/claude-fable-5", label: "Claude Fable 5", recommended: true, supportsImageInput: true },
      { id: "gemini/gemini-3.7-flash", label: "Gemini 3.7 Flash", recommended: true, supportsImageInput: true },
      { id: "xai/grok-4.6", label: "Grok 4.6", recommended: true, supportsImageInput: true },
      { id: "openai/gpt-5.5", label: "OpenAI GPT-5.5", supportsImageInput: true },
      { id: "anthropic/claude-opus-4-8", label: "Claude Opus 4.8", supportsImageInput: true },
  ...
  ollama: {
    ...
    models: [
      ...
      { id: "qwen3.6", label: "Qwen3.6", recommended: true, supportsImageInput: true },
  ...
  nvidia: {
    ...
    defaultReasoningEffort: "medium",
    models: [
      { id: "nvidia/nemotron-3-ultra-550b-a55b", label: "Nemotron 3 Ultra 550B A55B", recommended: true, supportsImageInput: false },
      { id: "nvidia/nemotron-3-super-120b-a12b", label: "Nemotron 3 Super 120B A12B", recommended: true, supportsImageInput: false },
  ...
  "openai-compatible": {
    ...
    models: [
      ...
      { id: "gemini-3.7-flash", label: "Gemini 3.7 Flash compatible", recommended: true, supportsImageInput: true },
