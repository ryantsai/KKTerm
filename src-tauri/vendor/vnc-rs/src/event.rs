...
/// Decode/transport measurements for one complete FramebufferUpdate message.
#[derive(Debug, Clone, Copy, Default)]
pub struct FramebufferUpdateMetrics {
    pub wire_bytes: u64,
    pub decode_micros: u64,
    pub rectangles: u32,
    pub raw_rectangles: u32,
    pub copy_rectangles: u32,
    pub tight_rectangles: u32,
    pub zrle_rectangles: u32,
    pub trle_rectangles: u32,
    pub cursor_rectangles: u32,
    pub desktop_size_rectangles: u32,
}
...
pub enum VncEvent {
    ...
    /// Marks the end of one complete FramebufferUpdate message. Consumers can
    /// use this boundary to batch drawing and request the next incremental
    /// update without building an open-loop request backlog.
    FramebufferUpdateComplete(FramebufferUpdateMetrics),
