...
const TUTORIAL_TOOL_KNOWN_TARGETS: &str = concat!(
    ...
    "terminal.pane, terminal.tmuxSessions, terminal.sshPortRedirect, terminal.startRecording, terminal.openSftp, notes.openNote, terminal.copySelection, terminal.sendToAi, terminal.actions, terminal.searchBar, terminal.surface with navigation page=workspace; ",
