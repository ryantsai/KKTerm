...
fn screenshot_library_context(
    ...
    Ok((
        screenshot::LibrarySaveOptions {
            ...
            open_in_editor_after_capture: settings.open_in_editor_after_capture(),
...
pub fn run() {
    ...
    configure_macos_updater(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            custom_modules::get_custom_module_data_usage,
            custom_modules::clear_custom_module_data,
            ...
            custom_modules::resolve_custom_module_secret_prompt,
            ...
            itops::vlan_commands::itops_list_vlans,
            itops::vlan_commands::itops_create_vlan,
            ...
            itops::ipam_commands::itops_create_ip_address,
