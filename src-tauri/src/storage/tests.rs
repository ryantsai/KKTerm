...
#[test]
fn ssh_connection_persists_remote_startup_directory() {
    let storage = Storage::open(temp_db_path("ssh-startup-directory")).expect("storage opens");
    ...
    let created = storage
        .create_connection(CreateConnectionRequest {
            ...
            auth_method: None,
            local_shell: None,
            local_startup_directory: Some("  /srv/apps/kkterm  ".to_string()),
            local_startup_script: Some("  ignored for ssh  ".to_string()),
            url: None,
            data_partition: None,
            url_proxy: None,
            url_proxy_inherit_defaults: None,
    ...
    assert_eq!(
        created.local_startup_directory.as_deref(),
        Some("/srv/apps/kkterm")
    );
    assert!(created.local_startup_script.is_none());
