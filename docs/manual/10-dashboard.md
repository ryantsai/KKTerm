...
- **Utility Instrument** — QR, hash, converter, calculator, parser, generator, formatter, encoder/decoder tools. Use panel chrome with explicit labels, validation, results, and copy/export actions.
