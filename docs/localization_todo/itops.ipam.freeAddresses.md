# itops.ipam.freeAddresses

- **English value**: `Free:`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Prefix of the suggestion row under the Address field listing up to five unused addresses.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Free" = not yet documented inside this prefix. Ends with a colon because addresses follow inline.`
