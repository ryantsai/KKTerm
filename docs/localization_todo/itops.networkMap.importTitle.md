# itops.networkMap.importTitle

- **English value**: `Import Hosts`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `heading`
- **User flow**: `Title of the dialog that seeds a map from documented Hosts.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Hosts" is the KKTerm IT Ops domain term.`
