# itops.networkMap.deleteTitle

- **English value**: `Delete Network Map?`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `heading`
- **User flow**: `Title of the confirm dialog for deleting a Network Map.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Question form, matching the other destructive confirms in KKTerm.`
