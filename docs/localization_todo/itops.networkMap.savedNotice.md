# itops.networkMap.savedNotice

- **English value**: `Saved Network Map “{{name}}”.`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `status`
- **User flow**: `Status-bar notice after saving the map's details or its drawing.`
- **Tone**: `short factual phrase`
- **Placeholders**: `{{name}} — each token must survive verbatim in every locale.`
- **Context/meaning**: `Past tense confirmation. Curly quotes wrap the name.`
