# terminal.quickCommandBundlesTitle

- **English value**: `Quick Command Bundles`
- **Namespace**: `terminal`
- **File/component**: `src/modules/workspace/connections/terminal/QuickCommandBar.tsx`
- **UI role**: `heading`
- **User flow**: `Title of the bundle picker dialog opened from the Quick Command Bar bundle chip.`
- **Tone**: `concise/neutral`
- **Placeholders**: `none`
- **Context/meaning**: `Bundle is a named, shared list of Quick Commands.`
...
<!--
Filename: terminal.quickCommandBundlesTitle.md
