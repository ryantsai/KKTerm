# itops.networkMap.weakHeading

- **English value**: `Single points of failure`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `heading`
- **User flow**: `Heading of the single-point-of-failure list in the What-If panel.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Standard networking term for a component whose loss alone breaks reachability.`
