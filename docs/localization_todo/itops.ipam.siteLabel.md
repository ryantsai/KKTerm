# itops.ipam.siteLabel

- **English value**: `Site`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Field label for the optional Site selector in the IP Prefix dialog.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Site" is the KKTerm domain term for a physical location in IT Ops.`
