# itops.ipam.columnAddresses

- **English value**: `Addresses`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Column header in the IP Prefix table.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Count of IP Address Records inside the prefix.`
