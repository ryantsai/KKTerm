# itops.networkMap.paletteLabel

- **English value**: `Add to map`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `Heading above the palette of node types in the editor sidebar.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Clicking a palette entry drops a new node onto the canvas.`
