# itops.networkMap.siteUnscoped

- **English value**: `All Sites`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `The no-Site choice in the Site selector, and the badge on maps with no Site.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Means "not tied to any one Site".`
