# itops.ipam.addressStatus.deprecated

- **English value**: `Deprecated`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Status option and row badge for an IP Address Record.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Being retired; do not assign it.`
