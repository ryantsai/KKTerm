# itops.ipam.dnsPlaceholder

- **English value**: `e.g. core-sw-01.example.com`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `placeholder`
- **User flow**: `Placeholder in the DNS name field.`
- **Tone**: `short example`
- **Placeholders**: `none`
- **Context/meaning**: `Sample fully-qualified hostname; keep it in ASCII.`
