# itops.ipam.prefixDeletedNotice

- **English value**: `Deleted prefix {{cidr}}.`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `status`
- **User flow**: `Status-bar notice after deleting an IP Prefix.`
- **Tone**: `short factual phrase`
- **Placeholders**: `{{cidr}} — each token must survive verbatim in every locale.`
- **Context/meaning**: `Confirms removal of the prefix only.`
