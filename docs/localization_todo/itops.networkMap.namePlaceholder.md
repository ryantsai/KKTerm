# itops.networkMap.namePlaceholder

- **English value**: `e.g. Core network`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `placeholder`
- **User flow**: `Placeholder in the Name field.`
- **Tone**: `short example`
- **Placeholders**: `none`
- **Context/meaning**: `Sample map name; translate the sample.`
