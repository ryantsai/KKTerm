# settings.screenshotsFolderHint

- **English value**: `Captured screenshots are saved to this folder and listed in the Screenshots Module.`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/ScreenshotsSettings.tsx`
- **UI role**: `fragment`
- **User flow**: Hint under the folder field.
- **Tone**: concise/neutral
- **Placeholders**: none
- **Context/meaning**: 'Screenshots Module' is the rail Module name.
