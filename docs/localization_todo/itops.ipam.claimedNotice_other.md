# itops.ipam.claimedNotice_other

- **English value**: `Imported {{count}} addresses.`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `status`
- **User flow**: `Status-bar notice after the import completes.`
...
- **Context/meaning**: `Past tense: the records now exist.`
