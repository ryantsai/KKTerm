# itops.networkMap.nodeKind.switch

- **English value**: `Switch`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `Palette entry, node type selector option, and node badge on the canvas.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `The network device, NOT a toggle control. If the locale's word for a UI switch differs, use the networking one.`
