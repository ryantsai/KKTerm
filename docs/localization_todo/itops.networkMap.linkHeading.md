# itops.networkMap.linkHeading

- **English value**: `Link`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `heading`
- **User flow**: `Heading of the inspector panel when a link is selected.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Link" is the KKTerm domain term Network Link.`
