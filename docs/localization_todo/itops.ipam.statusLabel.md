# itops.ipam.statusLabel

- **English value**: `Status`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Field label for the status selector in the IP Prefix dialog.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `The lifecycle state of the prefix, one of the prefixStatus values.`
