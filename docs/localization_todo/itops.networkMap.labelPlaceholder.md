# itops.networkMap.labelPlaceholder

- **English value**: `e.g. Core switch`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `placeholder`
- **User flow**: `Placeholder in the node Label field.`
- **Tone**: `short example`
- **Placeholders**: `none`
- **Context/meaning**: `Sample device name; translate the sample.`
