# itops.networkMap.removeNode

- **English value**: `Remove node`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `button`
- **User flow**: `Destructive button at the bottom of the node inspector.`
- **Tone**: `short imperative`
- **Placeholders**: `none`
- **Context/meaning**: `Deletes the node and its links from the drawing; nothing on the real network changes.`
