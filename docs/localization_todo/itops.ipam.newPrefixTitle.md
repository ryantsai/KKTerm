# itops.ipam.newPrefixTitle

- **English value**: `New Prefix`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `heading`
- **User flow**: `Title of the dialog opened by the Add action on the IPAM page.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Prefix" here is the KKTerm domain term IP Prefix, not a text prefix.`
