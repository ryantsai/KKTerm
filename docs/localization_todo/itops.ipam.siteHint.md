...
- **English value**: `Optional. Prefixes stay visible from every Site.`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `tooltip`
- **User flow**: `Hint under the Site field in the IP Prefix dialog.`
- **Tone**: `plain, one-sentence guidance`
- **Placeholders**: `none`
- **Context/meaning**: `Says the Site is a tag only: setting it never hides the prefix from other Sites.`
