# itops.ipam.previewRange

- **English value**: `Usable range`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/IpamPanel.tsx`
- **UI role**: `label`
- **User flow**: `Label in the live preview shown under the CIDR field while typing.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `The first-to-last usable host address the typed prefix covers.`
