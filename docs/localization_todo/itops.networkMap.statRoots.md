# itops.networkMap.statRoots

- **English value**: `Entry points`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `Label of a count tile in the Design sidebar.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Number of nodes marked as entry points; must match rootLabel's wording.`
