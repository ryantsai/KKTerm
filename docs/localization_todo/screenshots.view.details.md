# screenshots.view.details

- **English value**: `Details`
- **Namespace**: `screenshots`
- **File/component**: `src/modules/screenshots/ScreenshotsPage.tsx`
- **UI role**: `tooltip`
- **User flow**: View-mode switch option showing the library as a table with size/dimensions/date columns.
- **Tone**: concise/neutral
- **Placeholders**: none
- **Context/meaning**: View mode name, like Windows Explorer's Details view.
