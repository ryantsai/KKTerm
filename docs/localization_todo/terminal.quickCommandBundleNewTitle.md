# terminal.quickCommandBundleNewTitle

- **English value**: `New Quick Command Bundle`
- **Namespace**: `terminal`
- **File/component**: `src/modules/workspace/connections/terminal/QuickCommandBundles.tsx`
- **UI role**: `heading`
- **User flow**: `Title of the dialog that names a newly created bundle.`
...
<!--
Filename: terminal.quickCommandBundleNewTitle.md
