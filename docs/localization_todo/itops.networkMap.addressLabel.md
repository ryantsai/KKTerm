# itops.networkMap.addressLabel

- **English value**: `Address`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `Field label for the node's optional address in the inspector.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `Free text — usually an IP, but not validated and not linked to IPAM.`
