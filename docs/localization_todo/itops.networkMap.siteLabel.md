# itops.networkMap.siteLabel

- **English value**: `Site`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/NetworkMapDesigner.tsx`
- **UI role**: `label`
- **User flow**: `Field label for the optional Site selector in the Network Map dialog.`
- **Tone**: `concise/neutral, sentence case`
- **Placeholders**: `none`
- **Context/meaning**: `"Site" is the KKTerm IT Ops domain term.`
