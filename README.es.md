...
> 💚 **KKTerm es gratis, local-first, sin telemetría ni suscripción, desarrollado de forma independiente.**
> Si KKTerm te ahorra tiempo cada día, la mejor forma de apoyarlo es **comprar tu copia en Microsoft Store o Mac App Store**. **Pago único, sin suscripción** — la misma app que la versión gratuita de GitHub, y cada compra financia directamente correcciones, novedades y versiones firmadas con actualización automática.
>
> <p align="center">
...
>   <a href="https://apps.apple.com/tw/app/kkterm/id6806710046?mt=12"><img src="https://img.shields.io/badge/Mac_App_Store-Download_KKTerm_%E2%80%A2_One--time_payment-000000?style=for-the-badge&logo=apple&logoColor=white" alt="Descargar KKTerm en Mac App Store — pago único, sin suscripción" /></a>
> </p>
>
> <p align="center"><sub>¿Prefieres la versión gratuita? Descarga la última release de GitHub — sin cuenta, sin condiciones.</sub></p>
...
La versión de **Mac App Store** se ejecuta dentro del App Sandbox de Apple, así que no es idéntica a la versión gratuita.

- Los shells locales también están confinados: `$HOME` es el contenedor, por lo que no hay dotfiles, ni `~/.ssh`, ni herramientas de Homebrew. Las sesiones SSH remotas no se ven afectadas; para trabajo local sin restricciones usa la versión macOS de descarga directa.
...
- Sin grabación de vídeo ni menú de temporizador de apagado; la primera descarga de una conexión URL pide una carpeta de destino.
...
Si KKTerm te resulta útil, el mejor apoyo es comprarlo en [Microsoft Store](https://apps.microsoft.com/detail/9nvqc5cnwwjk?hl=zh-TW&gl=HK) o [Mac App Store](https://apps.apple.com/tw/app/kkterm/id6806710046?mt=12) (pago único, sin suscripción) — o [invítame a un café](https://buymeacoffee.com/ryantsai).
